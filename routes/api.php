...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('products/best-selling', 'App\Http\Controllers\Api\V2\ProductController@bestSeller');
    ...
    Route::post('products-by-attribute', 'App\Http\Controllers\Api\V2\ProductController@ProductByAttribue')->middleware('auth:sanctum');
    ...
    Route::post('get-user-by-access_token', 'App\Http\Controllers\Api\V2\UserController@getUserInfoByAccessToken')->middleware('auth:sanctum');
...
Route::group(['prefix' => 'v2/expert'], function () {
    ...
    Route::post('community/likes', [ExpertCommunity::class, 'like'])->middleware('throttle:10,1');
    Route::apiResource('community', ExpertCommunity::class)->middleware('auth:sanctum');
